...
def simulate_delayed_diffusion_short_epsilon(
    sample_rate=44100,
    ...
    - Reduced 3rd-Order Shear: Coefficient reduced to 0.15 for cleaner Epsilon branching.
    """
    ...
    # Reduced 3rd-Order Sinusoidal Profile (0.15 3rd-harmonic weighting)
...
def main():
    ...
    print("Generating Echo (0.1s Trunk + 3s Delay + Reduced 3rd Harmonic)...")
    t, audio = simulate_delayed_diffusion_short_epsilon(
    ...
    # 1. Save WAV Audio
    wav_file = "brams_delayed_diffusion_epsilon.wav"
    ...
    plt.title("BRAMS Network — (0.1s Trunk, Full Strength to t=5s, Delayed Diffusion t>5s)", color='white', fontsize=11)
    ...
    img_filename = "brams_delayed_diffusion_spectrogram.png"
