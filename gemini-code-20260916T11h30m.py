...
def synthesize_meteor_signal(
    ...
    # Geographic wind direction set to East-West in 3D ENU coordinates
    ...
    for i in active_indices:
        ...
        # Velocity field mapped across fixed ENU space
        velocity_ecef = v_horizontal[:, None] * wind_dir_enu[None, :]

        # Compute Doppler using full 3D bisector projection
